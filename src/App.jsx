    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-600 to-emerald-400">
      <div className="bg-white shadow-lg rounded-3xl p-16">
        ...
        <div className="mb-4 flex">
          ...
          <button
            onClick={addTodo}
            className=" btn-add bg-blue-500 text-white px-4 py-2 rounded-r-lg transition-colors"
          >
            Add
          </button>
        </div>
          ...
          {todos.map((todo) => (
            ...
            >
              ...
              <button
                ...
                className=" btn-delete ml-2 p-2 rounded-lg bg-red-500 text-white transition-colors"
              >
                Delete
              </button>
            </li>
